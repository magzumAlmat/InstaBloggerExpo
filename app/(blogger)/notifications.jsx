    ...
    <View style={{ flex: 1, backgroundColor: '#0A061E', paddingTop: 100 }}>
      {requests.length === 0 ? (
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', padding: 32 }}>
          ...
          <Text style={{ color: '#fff', fontSize: 20, fontWeight: '800', textAlign: 'center', marginTop: 20, lineHeight: 28 }}>Нет запросов</Text>
          <Text style={{ color: 'rgba(255,255,255,0.4)', fontSize: 15, textAlign: 'center', marginTop: 8, lineHeight: 22 }}>Уведомления от брендов появятся здесь.</Text>
        </View>
      ) : (
        <FlatList
          data={requests}
